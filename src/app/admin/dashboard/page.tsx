        ...
        >
          {attentionCount === 0 ? (
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              <Link href="/admin/crm" className="rounded-lg border border-white/60 bg-white/55 p-3 transition-colors hover:border-amber-300">
              ...
              <Link href="/admin/agents" className="rounded-lg border border-white/60 bg-white/55 p-3 transition-colors hover:border-cyan-300">
              ...
              <Link href="/admin/crm" className="rounded-lg border border-white/60 bg-white/55 p-3 transition-colors hover:border-rose-300">
