...
function IntegrationCard({
  ...
  return (
    <article className="relative overflow-hidden rounded-2xl border border-white/60 bg-white/55 shadow-sm shadow-slate-900/10 p-5 shadow-sm transition-all hover:border-cyan-300 hover:shadow-md">
